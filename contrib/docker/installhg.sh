...
# The version constraints should be kept in sync with setup.cfg.
PIPDEPENDS="black<26 coverage<7.13.0 dulwich>=0.20.11,<0.23.0 pyflakes pygments pylint setuptools_scm"
